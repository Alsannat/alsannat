...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'BrunoCanada_HrefLang' => 1,
        'Ced_City' => 0,
        'Ced_SmsaShipping' => 1,
        'CheckoutCom_Magento2' => 1,
        'Clarion_CustomerAttribute' => 1,
        'Criteo_OneTag' => 0,
        'Custom_AddOrderSumaryStepOne' => 1,
        'Custom_AddPhone' => 1,
        'Custom_Checkoutform' => 1,
        'Custom_City' => 1,
        'Custom_Contest' => 1,
        'Custom_Myaccount' => 1,
        'Custom_ProductIcon' => 1,
        'Custom_Sorter' => 1,
        'Custom_SpecialPrice' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Ebizmarts_MailChimp' => 1,
        'Evincemage_AdminOrderStatus' => 1,
        'Evincemage_AmastyAcartExtended' => 1,
        'Evincemage_CategoryOnSaleFilter' => 1,
        'Evincemage_City' => 1,
        'Evincemage_CreateAttribute' => 1,
        'Evincemage_District' => 1,
        'Evincemage_ProductAttributes' => 1,
        'Evincemage_Subscribers' => 1,
        'Evincemage_WhatsAppChat' => 1,
        'Hexasoft_IP2LocationCountryBlocker' => 1,
        'Hyperpay_Extension' => 1,
        'Ibnab_NotificationBar' => 1,
        'Klarna_Core' => 1,
        'Klarna_Ordermanagement' => 1,
        'Klarna_Kp' => 1,
        'Limesharp_Stockists' => 1,
        'Lotus_ChangeOrderStatus' => 1,
        'Lotus_Override' => 1,
        'Lotus_OverrideRulesCondition' => 1,
        'Lotus_SMSAShipment' => 1,
        'MGS_AjaxCart' => 1,
        ...
        'Naqel_Shipping' => 1,
        'Netrix_ConfigurableSkuSwitch' => 1,
        ...
        'Vnecoms_Sms' => 0,
        'Vnecoms_SmsVip1sms' => 1,
        'WebGate_SMSAShipping' => 1,
        'Webengage_Event' => 0,
        ...
        'Wyomind_Core' => 0,
        'Wyomind_ElasticsearchCore' => 0,
        'Wyomind_ElasticsearchAutocomplete' => 0,
        'Yotpo_Yotpo' => 1
    ]
];
