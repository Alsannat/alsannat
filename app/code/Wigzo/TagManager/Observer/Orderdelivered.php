...
class Orderdelivered implements \Magento\Framework\Event\ObserverInterface
{
    protected $order;
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) 
    {
      ...
      $userAgent = $this->_header->getHttpUserAgent();
           ...
           if(null == $shippingMethod || $shippingMethod =="")
           {
               return;
           }
           ...
           $totalqtyOtder =0;
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, $wigzo_host."/learn/" . $orgToken . "/orderdelivered/" . $cookieID."?_siteid=".$orgToken);
