...
use Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\AbstractConnectionPool;
use Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\Selectors\RoundRobinSelector;
use Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\Selectors\SelectorInterface;
use Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\StaticNoPingConnectionPool;
use Wyomind\ElasticsearchCore\Elasticsearch\Connections\Connection;
use Wyomind\ElasticsearchCore\Elasticsearch\Connections\ConnectionFactory;
...
use Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\Selectors;
use Wyomind\ElasticsearchCore\Elasticsearch\Serializers\SmartSerializer;
...
class ClientBuilder
{
    ...
    /**
     * @param \Wyomind\ElasticsearchCore\Elasticsearch\Serializers\SerializerInterface|string $serializer
     */
    ...
    /**
     * @param \Wyomind\ElasticsearchCore\Elasticsearch\ConnectionPool\Selectors\SelectorInterface|string $selector
     */
    ...
    public function build(): Client
    {
        ...
        if (is_null($this->endpoint)) {
            ...
            $this->endpoint = function ($class) use ($serializer) {
                $fullPath = '\\Wyomind\\ElasticsearchCore\\Elasticsearch\\Endpoints\\' . $class;
    ...
    /**
     * @return \Wyomind\ElasticsearchCore\Elasticsearch\Connections\Connection[]
     * @throws RuntimeException
     */
