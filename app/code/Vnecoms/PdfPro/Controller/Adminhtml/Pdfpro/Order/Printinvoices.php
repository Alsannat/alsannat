...
class Printinvoices extends \Vnecoms\PdfPro\Controller\Adminhtml\Pdfpro\Order\AbstractMassAction
{
    ...
    {
$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/dev16__massAction__.log');
...
$logger->info('Your text message');
        ...
        if($order_id){
            $invoicesCollection = $this->invoiceCollectionFactory->create()->setOrderFilter(['eq' => $order_id]);
        }else{
