    ...
    public function getElementHtml()
    {
        ...
        if ($this->isEnabled()) {
            ...
            $html = $this->_getButtonsHtml().
                ...
                <script type="text/javascript">
                //<![CDATA[
                window.tinyMCE_GZ = window.tinyMCE_GZ || {}; window.tinyMCE_GZ.loaded = true;require(["jquery", "mage/translate", "mage/adminhtml/events", "mage/adminhtml/wysiwyg/tiny_mce/setup", "mage/adminhtml/wysiwyg/widget", "pdfTinyMCE"], function(jQuery){' .
                "\n" .
    ...
    protected function _getPreviewButtonHtml($visible = true)
    {
        $html = $this->_getButtonHtml(
            [
                ...
                'onclick' => "require(['prototype','Vnecoms_PdfPro::jquery-fancybox/jquery.mousewheel-3.0.4.pack', 'Vnecoms_PdfPro::jquery-fancybox/jquery.fancybox-1.3.4.pack', 'tinymce4'], function(){
