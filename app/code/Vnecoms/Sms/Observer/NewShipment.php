    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if(
            ...
            foreach ($shipment->getAllTracks() as $track){
                ...
                $link = $track->getTitle();
                if($track->getTitle() == 'SHIPA.COM'){
                    $link = 'https://shipa.com/';
                }

                if($track->getTitle() == 'SMSA.COM' || $track->getTitle() == 'SMSA.com' || $track->getCarrierCode() == 'smsashipping'){
                    $link = 'https://smsaexpress.com/';
                }
