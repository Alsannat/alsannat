            ...
            foreach ($collection->getData() as $data) {
                switch ($data['variable_type']) {
                    case 'attribute':
                        ...
                        } else if ($data['attribute_id_customer'] != 0) {
                        ...
                        switch ($attributeInfo->getFrontendInput()) {
                            ...
                            case 'media_image':
                                ...
                                if ((!$productImage || $productImage == "no_selection")) {
                                    // TODO Need proccess if product not have image
                                }
                                ...
                                if ($productImage
                                    ...
                                    $imageAttribute = $attributeInfo->getAttributeCode() ? $attributeInfo->getAttributeCode() : 'small_image';
