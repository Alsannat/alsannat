...
class AddressAttributes implements LayoutProcessorInterface
{
    ...
    public function process($jsLayout)
    {
        ...
        if(isset($jsLayout['components']['checkout']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['field-row-3']['children']['street1'])){
            $jsLayout['components']['checkout']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['field-row-3']['children']['street1']['sortOrder'] = 1;
            $jsLayout['components']['checkout']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['field-row-3']['children']['street1']['config']['additionalClasses'] = 'neighborhood';
        }
        return $jsLayout;
    }
}
