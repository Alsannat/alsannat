 ...
 * Contest data helper
 */
namespace Custom\Contest\Helper;
...
{
    /**
     * Path to store config where count of contest posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'contest/view/items_per_page';
    ...
    /**
     * Remove Contest item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Custom\Contest\Model\Contest $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Contest Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Contest Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getContestPerPage()
    {
