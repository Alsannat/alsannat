        ...
        if (is_object($form) && $this->_helperData->isEnabled()) {
            ...
            $detailsFieldset->addField(
                ...
                [
                    ...
                    'title'  => __('Email'),
                    'required' => true,
                    'value'  => ($review) ? $review->getMpBprEmail() : ''
                ]
            );
            ...
            $detailsFieldset->addField(
                ...
                'text',
                [
                    'name'   => 'mp_bpr_location',
                    'label'  => __('Location'),
                    'title'  => __('Location'),
                    'value'  => ($review) ? $review->getMpBprLocation() : ''
                ]
            );
            ...
            $detailsFieldset->addField(
                ...
                [
                    'name'   => 'mp_bpr_helpful',
                    'label'  => __('Helpful Yes'),
                    'title'  => __('Helpful Yes'),
                    'value'  => ($review) ? $review->getMpBprHelpful() : 0
                ]
            );
            ...
            $detailsFieldset->addField(
                ...
                'text',
                [
                    'name'   => 'mp_bpr_helpful_no',
                    'label'  => __('Helpful No'),
                    'title'  => __('Helpful No'),
                    'value'  => ($review) ? $review->getMpBprHelpfulNo() : 0
                ]
            );
