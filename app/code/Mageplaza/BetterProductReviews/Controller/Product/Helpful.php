...
class Helpful extends Action
{
    ...
    public function execute()
    {
        ...
        $reviewFlag = $this->getRequest()->getParam('review_flag');
        /**
         * @var Review $review
         */
        ...
        if ($this->getRequest()->isAjax()) {
            try {
                ...
                $currentHelpfulNo         = (int) $review->getMpBprHelpfulNo();
                if($reviewFlag == 1){
                ...
                if($reviewFlag == 0){
                    $data['mp_bpr_helpful_no'] = $currentHelpfulNo + 1;
                    $result = [
                        'success'       => true,
                        'helpful_count_no' => $data['mp_bpr_helpful_no']
                    ];
                }
