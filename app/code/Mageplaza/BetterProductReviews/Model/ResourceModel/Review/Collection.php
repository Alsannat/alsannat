    ...
    public function addReviewDetailTable()
    {
        $this->getSelect()->join(
            ...
            [
                ...
                'mp_bpr_helpful_no'          => new Zend_Db_Expr('MAX(detail.mp_bpr_helpful_no)'),
                'mp_bpr_email'               => new Zend_Db_Expr('MAX(detail.mp_bpr_email)'),
                'mp_bpr_location'            => new Zend_Db_Expr('MAX(detail.mp_bpr_location)')
            ]
        );
