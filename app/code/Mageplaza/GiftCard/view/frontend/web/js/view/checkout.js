...
define([
    ...
    'mpIonRangeSlider'
], function ($, ko, Component, giftCard, applyCodeAction, cancelCodeAction, applyCreditAction, checkCodeAction, resolver, $t, quote, priceUtils) {
    'use strict';
    ...
    return Component.extend({
        ...
        getUsedGiftCardLabel: function (item) {
            ...
            var amountFormatted = priceUtils.formatPrice(parseFloat(item.amount), quote.getPriceFormat());
