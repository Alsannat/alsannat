...
{
    const ABANDONMENT_RATE = 'rated_total';
    const EMAILS_SENT = 'sent_total';
    const CARTS_RESTORED = 'restored_total';
    const ORDERS_PLACED = 'placed_total';
    const POTENTIAL_REVENUE = 'potential_revenue';
    const RECOVERED_REVENUE = 'recovered_revenue';
    const EFFICIENCY = 'efficiency';
    const OPEN_RATE = 'open_rate';
    const CLICK_RATE = 'click_rate';
    const RECOVERED_CARTS_RATE = 'recovered_carts_rate';
    const EMAIL_STATISTICS = 'email_statistics';
    const STATISTICS = 'statistics';
    const CHARTS = 'charts';
    const CAMPAIGNS_STATISTICS = 'campaigns_statistics';
    const TOP_5_FORGET_PRODUCTS = 'top_5_forget_products';
