            ...
            if (this.image.length) {
                ...
                if (this.options.size > 0) {
                    ...
                    if (parentWidth) {
                        ...
                        temwidth = parentWidth * this.options.size / 100;
                    }
                } else {
                    this.imageWidth = this.imageWidth + 'px';
                    temwidth = this.imageWidth;
                }
                ...
                if (this.imageHeight > 0) {
                    ...
                    this.setStyleIfNotExist(this.element, {
                        'height': (this.imageWidth * 0.75) + 'px'
                    });
                } else {
                    this.textElement.css('lineHeight', temwidth * 0.75 + 'px');
                    this.setStyleIfNotExist(this.element, {
                        'height': (temwidth * 0.75) + 'px'
                    });
                }
