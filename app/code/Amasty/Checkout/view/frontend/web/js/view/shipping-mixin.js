define(
    ...
    function (
        ...
        function isBillingAddressFormVisible() {
            var billingAddressFormComponent = registry.get({index: 'billing-address-form'});
            if (!billingAddressFormComponent) {
                var paymentMethod = quote.paymentMethod();
                if (!paymentMethod) {
                    return false;
                }
                billingAddressFormComponent = registry.get({index: paymentMethod.method+'-form'});
            }
            return billingAddressFormComponent
                && !billingAddressFormComponent.isAddressSameAsShipping()
                && !billingAddressFormComponent.isAddressDetailsVisible();
        }
