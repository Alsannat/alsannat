...
define([
...
], function ($, Component, ko, modal, magecheck, shippingMap, mapData, paymentData) {
  'use strict';
  var i = 1;
  var markerbilling = '';
  var selectedMethod = '';
  ...
  if (mapDataValue['status'] != '0') {   
    if (mapDataValue['api_key'] != null) {       
          ...
          var myLatLng = {lat:billLatitude?parseFloat(billLatitude):24.71197429324486, lng:billLongitude?parseFloat(billLongitude):46.672089904785174};
