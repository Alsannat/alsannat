...
define([
  ...
  $.widget('googlemappinaddress.mapjs', {
      _create: function() {
       ...
       //   var myLatLng = {lat:latitude?parseFloat(latitude):-25.33333, lng:longitude?parseFloat(longitude):131.044};
       var myLatLng = {lat:latitude?parseFloat(latitude):24.71197429324486, lng:longitude?parseFloat(longitude):46.672089904785174};
