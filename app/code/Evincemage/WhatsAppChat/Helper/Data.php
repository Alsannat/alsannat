...
namespace Evincemage\WhatsAppChat\Helper;
...
use Magento\Framework\App\RequestInterface;
 ...
 /**
  * Class Data
  * @package Evincemage\WhatsAppChat\Helper
  */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getWAIconUrl()
    {
        ...
        if (!$whatsAppIcon) {
            ...
            return $this->assetRepo->getUrlWithParams('Evincemage_WhatsAppChat::images/whatsapp-chat-button.png', $params);
        }
