...
class Track extends \Magento\Backend\App\Action
{
    ...
    {   
        ...
        $this->ltSMSAhelper->getSMSAShipmentsStatus($orderId);
        $resultRedirect->setPath('sales/order/index',['order_id'=>$orderId]);
        ...
        //         $awd_number = ($order->getData('awd_number'))? $order->getData('awd_number') : $smsaTrackNum;
        //         $awd_number_a = explode(",", $awd_number);
        //         $awd_status_fn = '';
        //         $i = 0;
        //         foreach ($awd_number_a as $awd_num) {
...
$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/hn_getSMSAShipmentsByOrderId.log');
