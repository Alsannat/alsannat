...
class TrackEmail extends \Magento\Backend\App\Action
{
    /**
    ...
    {   
        ...
        try {
            ...
            //$toEmail = 'kingcat18.166@gmail.com';
            $this->ltSMSAhelper->sendTrackEmail($order,$toEmail);
            $this->_messageManager->addSuccess(__('The Track Email has been sent successfully'));
            $resultRedirect->setPath('sales/order/view',['order_id'=>$orderId]);
            return $resultRedirect;
