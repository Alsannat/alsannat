                ...
                function initialize(response) {
                    ...
                    function bindInfoWindow(marker, map, infowindow, name, address, city, postcode, telephone, link, external_link, email) {
                        google.maps.event.addListener(marker, 'click', function() {
                            ...
                            contentString += '<p class="ask-for-directions get-directions" data-directions="DRIVING"><a href="https://www.google.com/maps/dir//' + marker.getPosition().lat() + ',' + marker.getPosition().lng() + '" target="_blank">Get Directions</a></p>';
                            contentString += '</div>';
