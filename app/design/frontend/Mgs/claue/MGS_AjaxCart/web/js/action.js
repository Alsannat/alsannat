define([
    ...
    jQuery.widget('mgs.action', {
        ...
        fire: function (tag, actionId, url, data, redirectToCatalog) {
			 if(jQuery('.amrelated-pack-wrapper .amrelated-checkbox').is(":checked")){
				jQuery('.amrelated-tocart-wrapper button').click();
				//return false;    
				setTimeout(function(){ this._fire(tag, actionId, url, []); }, 1000);
			 }
