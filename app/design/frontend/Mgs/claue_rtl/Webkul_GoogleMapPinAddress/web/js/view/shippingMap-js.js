  ...
  var mapDataValue = mapData.getMapData();
   return Component.extend({
      ...
      onElementRender: function () {
          ...
          searchbox.placeholder = "مربع البحث  ";
          let markers = [];
                  ...
                  for (var i=addrComp.length-1;i>=0;i--) 
                  {
                    ...
                    else if (addrComp[i].types[0] == "administrative_area_level_1")
                    {
                      ...
                      if($(document).find("div[name ='shippingAddress.region_id'] select[name = 'region_id']").length){
                          ...
                          $(document).find("div[name ='shippingAddress.region_id'] select[name='region_id'] option[value='']").attr("selected",true);
                        ...
                        { 
                          ...
                          //$(document).find("div[name ='shippingAddress.region'] input[name = region]").attr("value",'');
                          $(document).find('div[name ="shippingAddress.district"] select[name = "district"]').trigger('change');
                        }
                    ...
                    else if (addrComp[i].types[0] == "administrative_area_level_2")
                    {
                      ...
                      {
                          //console.log("city dropdown exists");
                          ...
                          { 
                            ...
                            {
                              //console.log("selecting this"+opState);
                          ...
                          {
                            //console.log("updating city dropdown with "+city);
