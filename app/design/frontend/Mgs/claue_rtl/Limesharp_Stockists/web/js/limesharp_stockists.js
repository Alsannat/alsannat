                    ...
                    function bindInfoWindow(marker, map, infowindow, name, address, city, postcode, telephone, link, external_link, email) {
                        google.maps.event.addListener(marker, 'click', function() {
                            ...
                            if (external_link) {
                                ...
                                contentString += '<p class="stockists-telephone"><a href="/' + config.moduleUrl + '/' + link + '" target="_blank">صفحة التفاصيل</a></p>'
                            }
                            if (telephone) {
                            ...
                            contentString += '<p class="ask-for-directions get-directions" data-directions="DRIVING"><a href="https://www.google.com/maps/dir//' + marker.getPosition().lat() + ',' + marker.getPosition().lng() + '" target="_blank">احصل على الاتجاهات</a></p>';
                            contentString += '</div>';
